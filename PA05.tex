...
\vspace{1em}
\begin{center}
  \includegraphics[width=0.7\textwidth]{query0plan.png}
\end{center}
\vspace{1em}
...
\end{itemize}
\begin{center}
  \includegraphics[width=0.7\textwidth]{query1plan.png}
\end{center}
\vspace{1em}
...
\vspace{1em}
\begin{center}
  \includegraphics[width=0.7\textwidth]{query2plan.png}
\end{center}
\vspace{1em}
\subsubsection{Plan For Optimisation}
\vspace{1em}
...
\begin{center}
\includegraphics[width=0.7\textwidth]{query3plan.png}
\end{center}
\noindent
